package com.Legacy.ofthe.Nile.ui.main.game.middle
...
import com.Legacy.ofthe.Nile.databinding.FragmentGameMiddleBinding
...
class GameMiddleFragment : Fragment(), OnTouchListener {

    private val binding by lazy { FragmentGameMiddleBinding.inflate(layoutInflater) }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            delay(200)
            viewModel.setupGameItemImgResources(listOfGameItemViews, 2)
